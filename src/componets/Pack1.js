...
function Pack1() {
  ...
  const [price, setPrice] = useState(71.2);
        ...
        <div className="pack1">
          ...
          <div className="content">
            ...
            <div className="quantity">
              <div className="quantity-box">
                <div className="q-box">
                  ...
                  <p>{quantity}</p>
                  {quantity > 0 ? (
                    <button className="arrow" onClick={countD}>
                      <svg
                        width="8"
                        height="6"
                        viewBox="0 0 8 6"
            ...
            <div className="options">
              <button className="b-option">Edit pack</button> |{" "}
              <button className="b-option" onClick={remove}>
                Remove
              </button>
            </div>
          </div>
